...
ldapsearch -x -H ldap://$rhost -D "$user@$domain" -w $pass -b "DC=logging,DC=htb" "(objectClass=user)" sAMAccountName 2>/dev/null | grep sAMAccountName | awk '{print $2}' | sort -u | tee ldap_users.txt

ldapsearch -x -H ldap://$rhost -D "CN=leo,CN=Users,DC=hexdump,DC=lab" -w "Hexdump123!" -b "DC=hexdump,DC=lab" "(objectClass=user)"
...
- **[SMB](139-445-smb-netbios.md)** - SMB enumeration